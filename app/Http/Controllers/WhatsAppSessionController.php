            ...
            switch ($case_no) {
                case '1':
                    if ($case_no == 1 && $step_no == 0) {
                        ...
                        $language_menu = "*CDH is conducting a survey. Choose language*\n";
                ...
                case '2':
                    ...
                    }elseif($case_no == 2 && $step_no == 5 && !empty($user_message)){
                        //Kalomo district
                        if(is_numeric($user_message)){
                            //save district
                            if ($user_message == "1" || $user_message == 1){
                                //Save Dundumwezi constituency
                                $save_data = DataSurvey::create([
                                    "session_id" => $session_id,
                                    "phone_number" => $from,
                                    "language_id" => WhatsAppSession::where('session_id', $session_id)->first()->language_id,
                    ...
                    if ($case_no == 3 && $step_no == 1 && !empty($user_message)) {
                        ...
                        if(is_numeric($user_message)){
                            ...
                            if ($user_message == "1" || $user_message == 1) {
                                ...
                                $chosen_ward = "Harry Mwanga Nkumbula";
                            } elseif ($user_message == "3" || $user_message == 3) {
                                $chosen_ward = "Munkolo";
                            }
                        ...
                        }elseif(!is_numeric($user_message) && $user_message > 5){
                            //repeat the Wards list
                            if ($language == 1) //english
                            {
                                $message_string = "*In which Ward do you stay in?* \n1. Kanyama\n2. Harry Mwanga Nkumbula\n3. Munkolo\n4. _Other(please specify)_";
                            } elseif ($language == 2) //nyanja
                            {
                                $message_string = "*In which Ward do you stay in?* \n1. Kanyama\n2. Harry Mwanga Nkumbula\n3. Munkolo\n4. _Other(please specify)_";
                            } elseif ($language == 3) //bemba
                        ...
                        //Lusaka Central wards

                        if(is_numeric($user_message)){
                            //save lusaka central wards
                            $chosen_ward = $user_message;

                            if ($user_message == "1" || $user_message == 1) {
                                $chosen_ward = "Silwizya";
                            } elseif ($user_message == "2" || $user_message == 2) {
                                $chosen_ward = "Independence";
                            } elseif ($user_message == "3" || $user_message == 3) {
                                $chosen_ward = "Lubwa";
                            } elseif ($user_message == "4" || $user_message == 3) {
                                $chosen_ward = "Kabulonga";
                            }
                        ...
                        if(is_numeric($user_message)){
                            //save mandevu selected ward
                            $chosen_ward = $user_message;

                            if ($user_message == "1" || $user_message == 1) {
                                $chosen_ward = "Roma";
                            } elseif ($user_message == "2" || $user_message == 2) {
                                $chosen_ward = "Mulungushi";
                            } elseif ($user_message == "3" || $user_message == 3) {
                                $chosen_ward = "Ngwerere";
                            } elseif ($user_message == "4" || $user_message == 3) {
                                $chosen_ward = "Chaisa";
                            }elseif ($user_message == "5" || $user_message == 3) {
                                $chosen_ward = "Justin Kabwe";
                            }elseif ($user_message == "6" || $user_message == 3) {
                                $chosen_ward = "Raphael Chota";
                            }elseif ($user_message == "7" || $user_message == 3) {
                                $chosen_ward = "Mpulungu";
                            }
                        ...
                        if(is_numeric($user_message)){
                            ...
                            if ($user_message == "1" || $user_message == 1) {
                                $chosen_ward = "Muchinga";
                            } elseif ($user_message == "2" || $user_message == 2) {
                                $chosen_ward = "Kapwepwe";
                            } elseif ($user_message == "3" || $user_message == 3) {
                                $chosen_ward = "Lima";
                            } elseif ($user_message == "4" || $user_message == 3) {
                                $chosen_ward = "Mwembeshi";
                            }elseif ($user_message == "5" || $user_message == 3) {
                                $chosen_ward = "Matero";
                            }
                        ...
                        if(is_numeric($user_message)){
                            ...
                            if ($user_message == "1" || $user_message == 1) {
                                ...
                                $chosen_ward = "Mtendere";
                            } elseif ($user_message == "3" || $user_message == 3) {
                                $chosen_ward = "Kalingalinga";
                            } elseif ($user_message == "4" || $user_message == 3) {
                                $chosen_ward = "Chakunkula";
                            }elseif ($user_message == "5" || $user_message == 3) {
                                $chosen_ward = "Munali";
                            }elseif ($user_message == "6" || $user_message == 3) {
                                $chosen_ward = "Chelstone";
                            }elseif ($user_message == "7" || $user_message == 3) {
                                $chosen_ward = "Avondale";
                            }
